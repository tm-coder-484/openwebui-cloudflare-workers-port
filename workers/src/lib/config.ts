...
export const DEFAULT_CONFIG: Record<string, unknown> = {
	...
	'oauth.enable': false,
	'oauth.provider_name': 'SSO',
	'oauth.client_id': '',
	'oauth.client_secret': '',
	'oauth.openid_provider_url': '',
	'oauth.openid_redirect_uri': '',
	'oauth.scopes': 'openid email profile',
	'oauth.email_claim': 'email',
	'oauth.username_claim': 'name',
	'oauth.picture_claim': 'picture',
	'oauth.sub_claim': '',
	'oauth.group_claim': 'groups',
	'oauth.roles_claim': 'roles',
	'oauth.enable_signup': false,
	'oauth.merge_accounts_by_email': false,
	'oauth.auto_redirect': false,
	'oauth.allowed_domains': '*',
	'oauth.enable_role_management': false,
	'oauth.enable_group_management': false,
	'oauth.enable_group_creation': false,
	'oauth.allowed_roles': 'user,admin',
	'oauth.admin_roles': 'admin',
	'oauth.blocked_groups': '[]',
	'oauth.update_name_on_login': false,
	'oauth.update_email_on_login': false,
	'oauth.update_picture_on_login': false,
